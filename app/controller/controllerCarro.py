...
def registrarCarro(id='', marca='', modelo='', year='', color='', cilindraje='', velocidad='', puertas='', favorito='', nuevoNombreFile=''):       
        conexion_MySQLdb = connectionBD()
        cursor           = conexion_MySQLdb.cursor(dictionary=True)
            
        sql         = ("INSERT INTO carros(id, marca, modelo, year, color, cilindraje, velocidad, puertas, favorito, foto) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)")
        valores     = (id, marca, modelo, year, color, cilindraje, velocidad, puertas, favorito, nuevoNombreFile)
